    ...
    return (
        <button
            ...
            style={{
                ...
                alignItems: "center",
                gap: 6,
                background: isIdle ? "none" : status === "copied" ? "rgba(74,222,128,0.12)" : "rgba(74,222,128,0.12)",
                border: `1px solid ${isIdle ? "var(--border)" : "rgba(74,222,128,0.5)"}`,
                borderRadius: 6,
                color: isIdle ? "var(--text-dim)" : "#4ade80",
                padding: "4px 10px",
                cursor: "pointer",
                fontFamily: "var(--mono)",
                fontSize: 11,
